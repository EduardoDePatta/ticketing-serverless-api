import { decodeRefreshToken, encodeRefreshToken, generateRefreshTokenSecret, hashRefreshTokenSecret, } from "../../../src/shared/auth/refreshTokenCodec";
describe("refreshTokenCodec", () => {
    ...
    describe("hashRefreshTokenSecret", () => {
        ...
        it("differs across inputs", () => {
            expect(hashRefreshTokenSecret({ secret: "a" })).not.toBe(hashRefreshTokenSecret({ secret: "b" }));
        });
