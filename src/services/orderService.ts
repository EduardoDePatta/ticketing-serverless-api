...
export class OrderService {
  ...
  constructor(params: OrderServiceParams = {}) {
    ...
    this.reservationTtlSeconds = params.reservationTtlSeconds ?? DEFAULT_RESERVATION_TTL_SECONDS;
  }
  async create(params: { input: unknown; customerId: string }): Promise<OrderServiceResult<Order>> {
  ...
  async getById(params: { id: string; customerId: string }): Promise<OrderServiceResult<Order>> {
