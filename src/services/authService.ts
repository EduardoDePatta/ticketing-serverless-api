...
import { constantTimeEqual } from "../helpers/constantTimeEqual";
...
export class AuthService {
  ...
  async register(params: { input: unknown }): Promise<AuthServiceResult<PublicUser>> {
  ...
  async login(params: { input: unknown }): Promise<AuthServiceResult<AuthSession>> {
  ...
  async refresh(params: { input: unknown }): Promise<AuthServiceResult<AuthSession>> {
    ...
    if (!constantTimeEqual({ a: expectedHash, b: stored.tokenHash })) {
      return {
        success: false,
        failure: { kind: "invalid_refresh_token" },
      };
  ...
  async logout(params: { input: unknown }): Promise<AuthServiceResult<void>> {
  ...
  async getById(params: { id: string }): Promise<AuthServiceResult<PublicUser>> {
  ...
  private async issueSession(params: { user: User; familyId: string }): Promise<AuthSession> {
